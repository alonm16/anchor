...
my_utils = TextUtils(anchor_examples, dev, explainer, predict_sentences, "results/trigger2_exps.pickle")
...
pickle.dump( explanations, open( "results/trigger2_exps_list.pickle", "wb" ))
