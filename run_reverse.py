...
folder_name = f'results/{dataset_name}/{sorting}/{optimization}-reverse' if optimization!='' else f'results/{dataset_name}/{sorting}/{delta}-reverse'
...
# reversing the list
anchor_examples = sort_function(anchor_examples)[::-1]
