...
def create_embedding_layer(input_vocabulary, embedding_dim):
...
class VanillaGRU(nn.Module):
    def __init__(self, input_vocabulary, embedding_dim, hidden_dim, num_layers, output_dim, dropout):
        super().__init__()

        self.embedding_layer, self.indices_to_zero = create_embedding_layer(input_vocabulary, embedding_dim)
        
        self.GRU_layer = nn.GRU(input_size=embedding_dim, hidden_size=hidden_dim, num_layers=num_layers, dropout=dropout)
